...
def success(request,hotel_id):
	...
	client_payment = request.POST['payment']

	client = Client(payment=client_payment,smoking=client_smoking,firstname=client_firstname,lastname=client_lastname,requirement=client_require)
	client.save()
